    ...
    public class StartUp
    {
        ...
        public static string ImportCategoryProducts(ProductShopContext context, string inputXml)
        {
            ...
            foreach (ImportCategoriesAndProductsDto category in importCategoriesAndProductsDtos)
            {
                ...
                bool productExists = context.Products.Any(p => p.Id == category.ProductId);
                // Check if the category with the given ID exists
                bool categoryExists = context.Categories.Any(c => c.Id == category.CategoryId);

                // Only proceed if both the product and category exist
